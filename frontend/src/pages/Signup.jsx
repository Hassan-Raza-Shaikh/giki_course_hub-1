    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--primary)' }}>Create Account</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '4px' }}>Join the GIKI student community</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <label style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-muted)' }}>Choose Username</label>
            <input 
              type="text" 
              required
        ...
        <div style={{ marginTop: '32px', textAlign: 'center', fontSize: '0.9rem' }}>
          ...
          <NavLink to="/login" style={{ color: 'var(--secondary)', fontWeight: 700 }}>Log In</NavLink>
        </div>
      </div>
    </div>
  );
